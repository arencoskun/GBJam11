...
public class AsteroidSpawner implements IGameObject {
    ...
    public AsteroidSpawner(GameObjectHandler objectHandler, ScoreHandler scoreHandler, SettingsHandler settingsHandler) {
    ...
    private void spawnAsteroid() {
        ...
        new Asteroid(objectHandler, spawnType, scoreHandler, settingsHandler, spawnPos);
